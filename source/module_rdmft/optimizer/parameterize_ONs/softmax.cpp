...
// void SOFTMAX::init(const int nk_total, const int nkstot_full, const std::vector<double> wk_in)
// {
...
void SOFTMAX::update_x_occ_num()
{
    
}


void SOFTMAX::get_dE_dx()
{
    
}


// ModuleBase::matrix SOFTMAX::get_occ_number()
// {
    
// }


void SOFTMAX::check_occ_num(std::vector<double>& x_pass)
{
